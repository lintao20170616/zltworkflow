...
--
-- Host: 127.0.0.1    Database: zltadmin
-- ------------------------------------------------------
...
CREATE TABLE `languages` (
  ...
  KEY `idx_sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='语言表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menus` VALUES (1,1,NULL,'系统管理','SystemManage','/system',NULL,NULL,1,1,'2026-01-23 17:28:17','2026-01-25 21:26:58'),(2,1,NULL,'用户信息管理','UserInfo','/userinfo','User',NULL,1,2,'2026-01-23 17:29:08','2026-01-25 21:27:06'),(3,1,NULL,'菜单管理','MenuManage','/menu',NULL,NULL,1,2,'2026-01-23 17:29:43','2026-01-25 21:27:02'),(5,1,NULL,'用户列表','UserList','/userlist',NULL,NULL,1,0,'2026-01-23 17:34:02','2026-01-26 15:47:17'),(6,2,NULL,'语言管理','Language','/language',NULL,NULL,1,1,'2026-01-23 22:03:25','2026-01-23 22:03:25'),(8,2,NULL,'应用管理','Project','/projects',NULL,NULL,1,2,'2026-01-23 22:04:52','2026-01-26 18:02:43'),(10,3,NULL,'首页','Home','/home',NULL,NULL,1,0,'2026-01-26 16:34:09','2026-01-26 16:34:09'),(11,2,NULL,'翻译任务','TranslationTasks','/translation/tasks',NULL,NULL,1,3,'2026-01-27 15:45:57','2026-01-27 15:46:16'),(12,3,NULL,'聊天机器人','Chat','/chat',NULL,NULL,1,1,'2026-01-28 15:32:38','2026-01-28 15:32:38'),(13,3,NULL,'AGENT配置管理','AgentConfig','/agent-config',NULL,NULL,1,3,'2026-01-28 17:48:15','2026-01-28 17:48:27'),(14,3,NULL,'工具管理','ToolManagement','/tool-management',NULL,NULL,1,4,'2026-01-29 19:34:59','2026-01-29 19:34:59'),(15,3,NULL,'工具执行记录','ToolExecutionHistory','/tool-execution-history',NULL,NULL,1,5,'2026-01-29 19:35:33','2026-01-29 19:35:33'),(16,3,NULL,'小红书运营','RedBook','/redbook',NULL,NULL,1,7,'2026-02-04 16:39:15','2026-02-04 16:39:15'),(17,3,NULL,'AI图片生成任务列表','ImageTaskList','/image-tasks',NULL,NULL,1,8,'2026-02-05 15:29:05','2026-02-05 16:15:04'),(18,4,NULL,'开发指南','guide','/guide/getting-started.html',NULL,NULL,1,0,'2026-02-05 18:15:20','2026-02-05 18:17:50'),(20,5,NULL,'项目列表','LowcodeProjects','/lowcode/projects',NULL,NULL,1,0,'2026-02-06 14:19:36','2026-02-06 14:19:36'),(21,6,NULL,'JavascriptTest','JavascriptTest','/javascript-test',NULL,NULL,1,0,'2026-02-12 14:19:54','2026-02-12 14:19:54');
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `systems` VALUES (1,'001','权限系统',1,0,NULL,1,'2026-01-23 17:25:35','2026-01-23 17:25:43'),(2,'002','翻译平台',1,0,NULL,2,'2026-01-23 22:01:14','2026-01-26 16:33:21'),(3,'003','Agent系统',1,1,'http://localhost:3001',3,'2026-01-26 16:33:07','2026-01-28 14:12:58'),(4,'004','组件文档平台',1,1,'http://localhost:5173',4,'2026-02-05 17:04:11','2026-02-05 18:14:03'),(5,'005','低代码平台',1,0,NULL,5,'2026-02-06 13:47:50','2026-02-06 13:47:50'),(6,'006','实验平台',1,0,NULL,6,'2026-02-12 14:15:12','2026-02-12 14:15:12');
...
-- Dump completed on 2026-02-26 14:20:40
