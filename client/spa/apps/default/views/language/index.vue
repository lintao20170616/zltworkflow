  ...
  <div class="language-manage">
    <el-card>
      <template #header>
        <div class="card-header">
          ...
          <div class="header-actions">
            <el-input v-model="query.keyword" placeholder="搜索代码/名称" clearable style="width: 220px" @keyup.enter="loadList" />
            <el-select v-model="query.status" placeholder="状态" clearable style="width: 140px" @change="loadList">
              <el-option label="启用" :value="1" />
              <el-option label="禁用" :value="0" />
            </el-select>
            <el-button type="primary" @click="openCreate">新增语言</el-button>
      ...
      <el-table v-loading="loading" :data="list" style="width: 100%">
        ...
        <el-table-column prop="code" label="语言代码" width="150" />
        <el-table-column prop="name" label="语言名称" min-width="150" />
        <el-table-column prop="nativeName" label="本地名称" min-width="150" />
        <el-table-column prop="flag" label="图标" width="100">
    ...
    <el-dialog v-model="dialogVisible" :title="dialogMode === 'create' ? '新增语言' : '编辑语言'" width="520px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
        <el-form-item label="语言代码" prop="code">
          <el-input v-model="form.code" placeholder="如：zh-CN, en-US" :disabled="dialogMode === 'edit'" />
        </el-form-item>
        ...
        <el-form-item label="本地名称" prop="nativeName">
          <el-input v-model="form.nativeName" placeholder="如：简体中文、English" />
        </el-form-item>
        <el-form-item label="图标标识" prop="flag">
          <el-input v-model="form.flag" placeholder="如：CN, US" />
        </el-form-item>
...
const handleDelete = async (row: LanguageItem) => {
  try {
    await ElMessageBox.confirm(`确认删除语言「${row.name}」？`, '提示', { type: 'warning' });
