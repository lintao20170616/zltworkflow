...
项目提供完整的文档体系，帮助开发者和AI助手快速理解项目：

| 文档名称 | 描述 | 路径 |
|----------|------|------|
| AI开发指南 | AI辅助开发的核心指南 | [doc/AI开发指南.md](doc/AI开发指南.md) |
| 业务逻辑详解 | 核心业务流程和功能模块说明 | [doc/业务逻辑详解.md](doc/业务逻辑详解.md) |
| 后端开发规范 | Egg.js后端开发最佳实践 | [doc/后端开发规范.md](doc/后端开发规范.md) |
| 前端开发规范 | Vue 3前端开发最佳实践 | [doc/前端开发规范.md](doc/前端开发规范.md) |
| 数据模型文档 | 数据库设计和数据模型说明 | [doc/数据模型文档.md](doc/数据模型文档.md) |
| 项目分析报告 | 项目整体分析报告 | [doc/项目分析报告.md](doc/项目分析报告.md) |
